...
export default function Slider() {
  ...
  return (
    <div className="relative container h-full flex justify-center items-center overflow-hidden">
      ...
      <div className="absolute w-5 md:w-10 top-1/2 right-0 transform z-50 -translate-y-1/2 text-3xl cursor-pointer" onClick={() => paginate(1)}>
        <Arrow />
      </div>

      <div className="absolute w-5 md:w-10 top-1/2 left-0 rotate-180 transform z-50 -translate-y-1/2 text-3xl cursor-pointer" onClick={() => paginate(-1)}>
        <Arrow />
      </div>
